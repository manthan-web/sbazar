...
const Navbar = () => {
  return (
    <nav className="flex bg-transparent md:backdrop-blur-none backdrop-blur-lg sticky top-0 items-center p-6 justify-between px-6 md:px-12">
    ...
    >
      ...
      >
        <Button className="rounded-2xl flex py-6 items-center">
