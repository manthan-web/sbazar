...
import { TransitionPanel } from "@/components/transition-panel/component";
...
function Button({
  ...
  return (
    <button
      onClick={onClick}
      type="button"
      className="relative flex text-lg h-8 shrink-0 scale-100 select-none appearance-none items-center justify-center rounded-lg border border-zinc-950/10 bg-transparent px-6 py-6 text-zinc-500 transition-colors hover:bg-zinc-100 hover:text-zinc-800 focus-visible:ring-2 active:scale-[0.98] dark:border-zinc-50/10 dark:text-zinc-50 dark:hover:bg-zinc-800"
    >
      {children}
    </button>
  );
...
export function TransitionPanelCard() {
  ...
  return (
    <div className="w-full max-w-lg text-lg px-4 sm:px-6 md:px-8 py-10 overflow-hidden mx-auto rounded-xl border border-zinc-950/10 bg-white dark:bg-zinc-700">
      <TransitionPanel
